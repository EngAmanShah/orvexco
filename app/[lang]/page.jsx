...
import Market2 from "@/components/MarketLeader/Market";
...
export default async function Home({ params }) {
  ...
  const content = {
    en: {
      ...
      heroButton: "Contact Us", // ADD THIS LINE
      shopNow: "Contact Us",
    ...
    ar: {
      ...
      heroButton: "تواصل معنا", // ADD THIS LINE
      shopNow: "تواصل معنا",
  ...
  const {
    heroTitle,
    heroDescription,
    heroButton, // NOW THIS IS DEFINED
    shopNow,
    whyChooseTitle,
    whyChooseDescription,
    features,
